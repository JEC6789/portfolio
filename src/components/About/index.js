        ...
        <>
            ...
            <section id="about-me">
                ...
                <div className="content">
                    <h3>The Now Now</h3>
                    <p>Sup everyone. I'm currently taking a coding bootcamp to learn more about web development and reinforce the skills in HTML and CSS I already have, and everything listed in the projects section was created as part of the bootcamp. Once that's over in August, I'll hopefully have the required skills to become a web developer for whoever might be interested in me.</p>
